...
class t3lib_extFileFunctions extends t3lib_basicFileFunctions {
	 ...
	 */
		// @todo: deprecated function. To be put in Storage with a better concept
		// @todo: remove property $this->useRecycler at the same time
	...
	protected function getFileObject($identifier) {
		$object = $this->fileFactory->getObjectFromCombinedIdentifier($identifier);
