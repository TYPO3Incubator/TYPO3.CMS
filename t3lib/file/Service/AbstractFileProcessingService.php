 ...
 * @subpackage t3lib
 */
abstract class t3lib_file_Service_AbstractFileProcessingService {
	/**
	 ...
	 */
	abstract public function process(t3lib_file_File $file, $context, array $configuration = array());
}
?>