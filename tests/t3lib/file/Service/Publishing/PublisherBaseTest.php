...
/**
 * Base class for all resource publisher tests
 *
...
class t3lib_file_Service_Publishing_PublisherBaseTest extends Tx_Phpunit_TestCase {
	...
	protected function mockTarget() {
		...
		$target = $this->getMock('t3lib_file_Storage', array(), array(), '', FALSE);
		$target->expects($this->any())->method('getDriver')->will($this->returnValue($driver));
