...
class t3lib_file_StorageTest extends t3lib_file_BaseTestCase {
	...
	public function addFileChangesFilenameIfFileExists() {
		$mockedFolder = $this->getSimpleFolderMock('/');
		$mockedFolder->expects($this->exactly(3))->method('hasFile')->will($this->onConsecutiveCalls(
	...
	public function moveFileCallsDriversRawMethodsWithCorrectArguments() {
		...
		$sourceStorage = new t3lib_file_Storage($sourceDriver, array());
		...
		/** @var $fixture t3lib_file_Storage */
		$fixture = $this->getMock('t3lib_file_Storage', array('checkFileMovePermissions', 'updateFile'), array($driver, array()));
	...
	public function copyFileCallsDriversRawMethodsWithCorrectArguments() {
		...
		/** @var $fixture t3lib_file_Storage */
		$fixture = $this->getMock('t3lib_file_Storage', array('checkFileCopyPermissions'), array($driver, array()));
